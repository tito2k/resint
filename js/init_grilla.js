...
/*
         ...
         {name:'note',index:'note', width:150, sortable:false}*/
				...
				{name:'invdate',index:'invdate', width:80,editable:false,editoptions:{size:10}}, 
      ...
      viewrecords: true,
      sortorder: "desc",
			editurl:"../grilla/mante.php",
      caption:"JSON Example"
   });
   //jQuery("#list").jqGrid('navGrid','#pager',{height:280,reloadAfterSubmit:false},{reloadAfterSubmit:false});
		jQuery("#list").jqGrid('navGrid','#pager', {height:280,reloadAfterSubmit:false}, //options 
		{reloadAfterSubmit:false,closeAfterEdit:false}, // edit options 
		{reloadAfterSubmit:false,closeAfterAdd:true}, // add options 
