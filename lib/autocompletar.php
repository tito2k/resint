...
*/
function autocompletar($colClave,$colDesc,$colBuscar,$tabla,$valor)
{
// Cuantas tupla devolver
$tuplas = 10;

   $db = dbConnect("resint");
   $rs = $db->query("SELECT $colClave, $colDesc FROM $tabla WHERE $colBuscar REGEXP '$valor' ORDER BY $colBuscar LIMIT $tuplas");
